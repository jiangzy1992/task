(window._gsQueue || (window._gsQueue = [
  ...
  window._gsDefine('TweenMax', [
    ...
    h.render = function (t, e, i) {
      ...
      d = this._cycle,
      g = this._duration;
      if (t >= c ? (this._totalTime = c, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0)  : 0)  : (this._time = g, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1)  : 1), this._reversed || (s = !0, r = 'onComplete'), 0 === g && (p = this._rawPrevTime, (0 === t || 0 > p || p === n) && p !== t && (i = !0, p > n && (r = 'onReverseComplete')), this._rawPrevTime = p = !e || t || 0 === p ? t : n))  : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0)  : 0, (0 !== m || 0 === g && this._rawPrevTime > n) && (r = 'onReverseComplete', s = this._reversed), 0 > t ? (this._active = !1, 0 === g && (this._rawPrevTime >= 0 && (i = !0), this._rawPrevTime = p = !e || t || 0 === this._rawPrevTime ? t : n))  : this._initted || (i = !0))  : (this._totalTime = this._time = t, 0 !== this._repeat && (o = g + this._repeatDelay, this._cycle = this._totalTime / o >> 0, 0 !== this._cycle && this._cycle === this._totalTime / o && this._cycle--, this._time = this._totalTime - this._cycle * o, this._yoyo && 0 !== (1 & this._cycle) && (this._time = g - this._time), this._time > g ? this._time = g : 0 > this._time && (this._time = 0)), this._easeType ? (h = this._time / g, _ = this._easeType, u = this._easePower, (1 === _ || 3 === _ && h >= 0.5) && (h = 1 - h), 3 === _ && (h *= 2), 1 === u ? h *= h : 2 === u ? h *= h * h : 3 === u ? h *= h * h * h : 4 === u && (h *= h * h * h * h), this.ratio = 1 === _ ? 1 - h : 2 === _ ? h : 0.5 > this._time / g ? h / 2 : 1 - h / 2)  : this.ratio = this._ease.getRatio(this._time / g)), f === this._time && !i && d === this._cycle) return void (m !== this._totalTime && this._onUpdate && (e || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || l)));
      if (!this._initted) {
        if (this._init(), !this._initted || this._gc) return;
        this._time && !s ? this.ratio = this._ease.getRatio(this._time / g)  : s && this._ease._calcEnd && (this.ratio = this._ease.getRatio(0 === this._time ? 0 : 1))
      }
      for (this._active || !this._paused && this._time !== f && t >= 0 && (this._active = !0), 0 === m && (this._startAt && (t >= 0 ? this._startAt.render(t, e, i)  : r || (r = '_dummyGS')), this.vars.onStart && (0 !== this._totalTime || 0 === g) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || l))), a = this._firstPT; a; ) a.f ? a.t[a.p](a.c * this.ratio + a.s)  : a.t[a.p] = a.c * this.ratio + a.s,
      a = a._next;
    ...
    var _ = function (t, e) {
      for (var s = [
      ], r = 0, n = t._first; n; ) n instanceof i ? s[r++] = n : (e && (s[r++] = n), s = s.concat(_(n, e)), r = s.length),
      n = n._next;
      return s
    },
    ...
    var p = function (t, i, s, r) {
      ...
      s = s !== !1,
      r = r !== !1;
      for (var n, a, o = u(r), h = i && s && r, l = o.length; --l > - 1; ) a = o[l],
  ...
  window._gsDefine('TimelineLite', [
    ...
    u.staggerTo = function (t, e, r, a, o, l, u, p) {
      ...
      for ('string' == typeof t && (t = i.selector(t) || t), n(t) && (t = _.call(t, 0)), a = a || 0, c = 0; t.length > c; c++) r.startAt && (r.startAt = h(r.startAt)),
      f.to(t[c], e, h(r), c * a);
      return this.add(f, o)
    },
    ...
    u.render = function (t, e, i) {
      ...
      c = this._timeScale,
      f = this._paused;
      if (t >= _ ? (this._totalTime = this._time = _, this._reversed || this._hasPausedChild() || (n = !0, h = 'onComplete', 0 === this._duration && (0 === t || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && (l = !0, this._rawPrevTime > r && (h = 'onReverseComplete'))), this._rawPrevTime = this._duration || !e || t || 0 === this._rawPrevTime ? t : r, t = _ + 0.0001)  : 1e-7 > t ? (this._totalTime = this._time = 0, (0 !== u || 0 === this._duration && (this._rawPrevTime > r || 0 > t && this._rawPrevTime >= 0)) && (h = 'onReverseComplete', n = this._reversed), 0 > t ? (this._active = !1, 0 === this._duration && this._rawPrevTime >= 0 && this._first && (l = !0), this._rawPrevTime = t)  : (this._rawPrevTime = this._duration || !e || t || 0 === this._rawPrevTime ? t : r, t = 0, this._initted || (l = !0)))  : this._totalTime = this._time = this._rawPrevTime = t, this._time !== u && this._first || i || l) {
        if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== u && t > 0 && (this._active = !0), 0 === u && this.vars.onStart && 0 !== this._time && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || o)), this._time >= u) for (s = this._first; s && (a = s._next, !this._paused || f); ) (s._active || s._startTime <= this._time && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration()  : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i)  : s.render((t - s._startTime) * s._timeScale, e, i)),
        s = a;
         else for (s = this._last; s && (a = s._prev, !this._paused || f); ) (s._active || u >= s._startTime && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration()  : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i)  : s.render((t - s._startTime) * s._timeScale, e, i)),
        s = a;
    ...
    u.getTweensOf = function (t, e) {
      for (var s = i.getTweensOf(t), r = s.length, n = [
      ], a = 0; --r > - 1; ) (s[r].timeline === this || e && this._contains(s[r])) && (n[a++] = s[r]);
      return n
    },
  ...
  window._gsDefine('TimelineMax', [
    ...
    o.render = function (t, e, i) {
      ...
      v = this._paused,
      y = this._cycle;
      if (t >= u ? (this._locked || (this._totalTime = u, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (a = !0, h = 'onComplete', 0 === this._duration && (0 === t || 0 > g || g === r) && g !== t && this._first && (l = !0, g > r && (h = 'onReverseComplete'))), this._rawPrevTime = this._duration || !e || t || 0 === this._rawPrevTime ? t : r, this._yoyo && 0 !== (1 & this._cycle) ? this._time = t = 0 : (this._time = p, t = p + 0.0001))  : 1e-7 > t ? (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== c || 0 === p && (g > r || 0 > t && g >= 0) && !this._locked) && (h = 'onReverseComplete', a = this._reversed), 0 > t ? (this._active = !1, 0 === p && g >= 0 && this._first && (l = !0), this._rawPrevTime = t)  : (this._rawPrevTime = p || !e || t || 0 === this._rawPrevTime ? t : r, t = 0, this._initted || (l = !0)))  : (0 === p && 0 > g && (l = !0), this._time = this._rawPrevTime = t, this._locked || (this._totalTime = t, 0 !== this._repeat && (_ = p + this._repeatDelay, this._cycle = this._totalTime / _ >> 0, 0 !== this._cycle && this._cycle === this._totalTime / _ && this._cycle--, this._time = this._totalTime - this._cycle * _, this._yoyo && 0 !== (1 & this._cycle) && (this._time = p - this._time), this._time > p ? (this._time = p, t = p + 0.0001)  : 0 > this._time ? this._time = t = 0 : t = this._time))), this._cycle !== y && !this._locked) {
        ...
        P = this._rawPrevTime,
        S = this._time;
        if (this._totalTime = y * p, y > this._cycle ? T = !T : this._totalTime += p, this._time = c, this._rawPrevTime = 0 === p ? g - 0.0001 : g, this._cycle = y, this._locked = !0, c = T ? 0 : p, this.render(c, e, 0 === p), e || this._gc || this.vars.onRepeat && this.vars.onRepeat.apply(this.vars.onRepeatScope || this, this.vars.onRepeatParams || n), w && (c = T ? p + 0.0001 : - 0.0001, this.render(c, !0, !1)), this._locked = !1, this._paused && !v) return;
        this._time = S,
        this._totalTime = x,
        this._cycle = b,
        this._rawPrevTime = P
      ...
      if (this._initted || (this._initted = !0), this._active || !this._paused && this._totalTime !== f && t > 0 && (this._active = !0), 0 === f && this.vars.onStart && 0 !== this._totalTime && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || n)), this._time >= c) for (s = this._first; s && (o = s._next, !this._paused || v); ) (s._active || s._startTime <= this._time && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration()  : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i)  : s.render((t - s._startTime) * s._timeScale, e, i)),
      s = o;
       else for (s = this._last; s && (o = s._prev, !this._paused || v); ) (s._active || c >= s._startTime && !s._paused && !s._gc) && (s._reversed ? s.render((s._dirty ? s.totalDuration()  : s._totalDuration) - (t - s._startTime) * s._timeScale, e, i)  : s.render((t - s._startTime) * s._timeScale, e, i)),
      s = o;
  ...
  function () {
    ...
    l = function (t, s, r, a) {
      ...
      if (a) for (t = [
        a
      ].concat(t), h = t.length; --h > - 1; ) 'string' == typeof (p = t[h][s]) && '=' === p.charAt(1) && (t[h][s] = a[s] + Number(p.charAt(0) + p.substr(2)));
    ...
    _ = function (t, n, o, _, u, p) {
      ...
      if (t.length > 1) {
        for (T = t[t.length - 1], y = !0, c = x.length; --c > - 1; ) if (f = x[c], Math.abs(b[f] - T[f]) > 0.05) {
          y = !1;
          break
        }
    ...
    u = function (t, e, i) {
      ...
      for (l = v.length; --l > - 1; ) {
        for (p = v[l], m[p] = h = [
        ], c = 0, u = t.length, _ = 0; u > _; _++) s = null == i ? t[_][p] : 'string' == typeof (f = t[_][p]) && '=' === f.charAt(1) ? i[p] + Number(f.charAt(0) + f.substr(2))  : Number(f),
    ...
    p = function (t, e, i) {
      for (var s, r, n, a, o, h, l, _, u, p, c, f = 1 / i, m = t.length; --m > - 1; ) for (p = t[m], n = p.a, a = p.d - n, o = p.c - n, h = p.b - n, s = r = 0, _ = 1; i >= _; _++) l = f * _,
      u = 1 - l,
    ...
    f = window._gsDefine.plugin({
      ...
      init: function (t, e, i) {
        ...
        if (f = this._autoRotate) for (f[0] instanceof Array || (this._autoRotate = f = [
          f
        ]), n = f.length; --n > - 1; ) for (a = 0; 3 > a; a++) s = f[n][a],
      ...
      set: function (e) {
        ...
        if (this._autoRotate) {
          ...
          a && m && (a = a[i], m = m[i], d = a.a + (a.b - a.a) * o, v = a.b + (a.c - a.b) * o, d += (v - d) * o, v += (a.c + (a.d - a.c) * o - v) * o, g = m.a + (m.b - m.a) * o, y = m.b + (m.c - m.b) * o, g += (y - g) * o, y += (m.c + (m.d - m.c) * o - y) * o, h = Math.atan2(y - g, v - d) * w + T, c[n] ? f[n](h)  : f[n] = h)
        }
      }
    }),
    m = f.prototype;
      ...
      if (t) {
        ...
        e._registerComplexSpecialProp('bezier', {
          parser: function (t, e, n, a, o, h) {
            ...
            !d.autoRotate || d.autoRotate instanceof Array || (l = d.autoRotate === !0 ? 0 : Number(d.autoRotate), d.autoRotate = null != u.end.left ? [
              ['left',
              'top',
              'rotation',
              l,
  ...
  window._gsDefine('plugins.CSSPlugin', [
    ...
    te = function (t, e, i) {
      ...
      r = K[e],
      n = r.length;
      for (i = i || W(t, null); --n > - 1; ) s -= parseFloat(Z(t, 'padding' + r[n], i, !0)) || 0,
    ...
    re = function (t, e, i, s) {
      ...
      o,
      h = 0.000001;
      return null == t ? o = e : 'number' == typeof t ? o = t : (r = 360, n = t.split('_'), a = Number(n[0].replace(v, '')) * ( - 1 === t.indexOf('rad') ? 1 : X) - ('=' === t.charAt(1) ? 0 : e), n.length && (s && (s[i] = e + a), - 1 !== t.indexOf('short') && (a %= r, a !== a % (r / 2) && (a = 0 > a ? a + r : a - r)), - 1 !== t.indexOf('_cw') && 0 > a ? a = (a + 9999999999 * r) % r - (0 | a / r) * r : - 1 !== t.indexOf('ccw') && a > 0 && (a = (a - 9999999999 * r) % r - (0 | a / r) * r)), o = e + a),
      h > o && o > - h && (o = 0),
      o
    },
    ne = {
    ...
    oe = function (t) {
      ...
      return t && '' !== t ? 'number' == typeof t ? [
        ...
        255 & t >> 8,
        255 & t
      ])  : 'hsl' === t.substr(0, 3) ? (t = t.match(m), r = Number(t[0]) % 360 / 360, n = Number(t[1]) / 100, a = Number(t[2]) / 100, i = 0.5 >= a ? a * (n + 1)  : a + n - a * n, e = 2 * a - i, t.length > 3 && (t[3] = Number(t[3])), t[0] = ae(r + 1 / 3, e, i), t[1] = ae(r, e, i), t[2] = ae(r - 1 / 3, e, i), t)  : (t = t.match(m) || ne.transparent, t[0] = Number(t[0]), t[1] = Number(t[1]), t[2] = Number(t[2]), t.length > 3 && (t[3] = Number(t[3])), t))  : ne.black
    },
    ...
    ue = (E._setPluginRatio = function (t) {
      ...
      for (var e, i, s, r, n = this.data, a = n.proxy, o = n.firstMPT, h = 0.000001; o; ) e = a[o.v],
    ...
    ce = a.parseComplex = function (t, e, i, s, r, n, a, o, h, _) {
      ...
      A = R.length,
      C = l !== !1;
      for (( - 1 !== s.indexOf(',') || - 1 !== i.indexOf(',')) && (R = R.join(' ').replace(D, ', ').split(' '), k = k.join(' ').replace(D, ', ').split(' '), A = R.length), A !== k.length && (R = (n || '').split(' '), A = R.length), a.plugin = h, a.setRatio = _, u = 0; A > u; u++) if (f = R[u], g = k[u], T = parseFloat(f), T || 0 === T) a.appendXtra('', T, ie(g, T), g.replace(d, ''), C && - 1 !== g.indexOf('px'), !0);
       else if (r && ('#' === f.charAt(0) || ne[f] || b.test(f))) S = ',' === g.charAt(g.length - 1) ? '),' : ')',
      f = oe(f),
      g = oe(g),
      w = f.length + g.length > 6,
      w && !Y && 0 === g[3] ? (a['xs' + a.l] += a.l ? ' transparent' : 'transparent', a.e = a.e.split(k[u]).join('transparent'))  : (Y || (w = !1), a.appendXtra(w ? 'rgba(' : 'rgb(', f[0], g[0] - f[0], ',', !0, !0).appendXtra('', f[1], g[1] - f[1], ',', !0).appendXtra('', f[2], g[2] - f[2], w ? ',' : S, !0), w && (f = 4 > f.length ? 1 : f[3], a.appendXtra('', f, (4 > g.length ? 1 : g[3]) - f, S, !1)));
       else if (v = f.match(m)) {
    ...
    h.parseComplex = function (t, e, i, s, r, n) {
      ...
      u,
      p = this.keyword;
      if (this.multi && (D.test(i) || D.test(e) ? (o = e.replace(D, '|').split('|'), h = i.replace(D, '|').split('|'))  : p && (o = [
        e
      ], h = [
        i
      ])), h) {
    ...
    be = function (t, e, i, s) {
      ...
      for (ye ? r = Z(t, Te, e, !0)  : t.currentStyle && (r = t.currentStyle.filter.match(C), r = r && 4 === r.length ? [
        r[0].substr(4),
        Number(r[2].substr(4)),
        Number(r[1].substr(4)),
        r[3].substr(4),
        v.x || 0,
        v.y || 0
      ].join(',')  : ''), n = (r || '').match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], o = n.length; --o > - 1; ) h = Number(n[o]),
      ...
      if (16 === n.length) {
        ...
        if (v.zOrigin && (D = - v.zOrigin, A = S * D - n[12], O = R * D - n[13], D = k * D + v.zOrigin - n[14]), !i || s || null == v.rotationX) {
          ...
          K = - b > H || H > b;
          v.rotationX = H * X,
          H && (L = Math.cos( - H), E = Math.sin( - H), I = q * L + S * E, N = W * L + R * E, F = $ * L + k * E, S = q * - E + S * L, R = W * - E + R * L, k = $ * - E + k * L, Q = G * - E + Q * L, q = I, W = N, $ = F),
          H = Math.atan2(S, U),
          v.rotationY = H * X,
          H && (z = - b > H || H > b, L = Math.cos( - H), E = Math.sin( - H), I = U * L - S * E, N = j * L - R * E, F = B * L - k * E, R = j * E + R * L, k = B * E + k * L, Q = V * E + Q * L, U = I, j = N, B = F),
          H = Math.atan2(j, W),
          v.rotation = H * X,
          H && (Y = - b > H || H > b, L = Math.cos( - H), E = Math.sin( - H), U = U * L + q * E, N = j * L + W * E, W = j * - E + W * L, $ = B * - E + $ * L, j = N),
          Y && K ? v.rotation = v.rotationX = 0 : Y && z ? v.rotation = v.rotationY = 0 : z && K && (v.rotationY = v.rotationX = 0),
          v.scaleX = (0 | Math.sqrt(U * U + j * j) * w + 0.5) / w,
          v.scaleY = (0 | Math.sqrt(W * W + R * R) * w + 0.5) / w,
          v.scaleZ = (0 | Math.sqrt($ * $ + k * k) * w + 0.5) / w,
          v.skewX = 0,
        ...
        p = te || ee ? Math.atan2(ee, te) * X : v.rotation || 0,
        c = ie || se ? Math.atan2(ie, se) * X + p : v.skewX || 0,
        ...
        d = (p - v.rotation) % 180,
        g = (c - v.skewX) % 180,
        (void 0 === v.skewX || f > T || - T > f || m > T || - T > m || d > - x && x > d && !1 | d * w || g > - x && x > g && !1 | g * w) && (v.scaleX = _, v.scaleY = u, v.rotation = p, v.skewX = c),
    ...
    Pe = function (t) {
      ...
      if (p) {
        ...
        if (null != s.ox && (c = (s.oxp ? 0.01 * d * s.ox : s.ox) - d / 2, m = (s.oyp ? 0.01 * g * s.oy : s.oy) - g / 2, x += c - (c * o + m * h), b += m - (c * l + m * _)), v ? (c = d / 2, m = g / 2, w += ', Dx=' + (c - (c * o + m * h) + x) + ', Dy=' + (m - (c * l + m * _) + b) + ')')  : w += ', sizingMethod=\'auto expand\')', u.filter = - 1 !== e.indexOf('DXImageTransform.Microsoft.Matrix(') ? e.replace(O, w)  : w + ' ' + e, (0 === t || 1 === t) && 1 === o && 0 === h && 0 === l && 1 === _ && (v && - 1 === w.indexOf('Dx=0, Dy=0') || T.test(e) && 100 !== parseFloat(RegExp.$1) || - 1 === e.indexOf('gradient(' && e.indexOf('Alpha')) && u.removeAttribute('filter')), !v) {
          ...
          R = i !== s[S] ? 2 > fe ? - s.ieOffsetX : - s.ieOffsetY : 2 > fe ? c - s.ieOffsetX : m - s.ieOffsetY,
          u[S] = (s[S] = Math.round(i - R * (0 === fe || 2 === fe ? 1 : k))) + 'px'
        }
      }
    },
    Se = function () {
      ...
      if (R || P.skewX) v = Math.cos(R),
      y = Math.sin(R),
      t = v,
      r = y,
      P.skewX && (R -= P.skewX * M, v = Math.cos(R), y = Math.sin(R)),
      e = - y,
      n = v;
       else {
      ...
      g = 100000,
      R = P.rotationY * M,
      R && (v = Math.cos(R), y = Math.sin(R), h = _ * - y, c = m * - y, i = t * y, a = r * y, _ *= v, m *= v, t *= v, r *= v),
      R = P.rotationX * M,
      R && (v = Math.cos(R), y = Math.sin(R), T = e * v + i * y, w = n * v + a * y, x = l * v + _ * y, b = f * v + m * y, i = e * - y + i * v, a = n * - y + a * v, _ = l * - y + _ * v, m = f * - y + m * v, e = T, n = w, l = x, f = b),
      1 !== C && (i *= C, a *= C, _ *= C, m *= C),
      1 !== A && (e *= A, n *= A, l *= A, f *= A),
      1 !== k && (t *= k, r *= k, h *= k, c *= k),
    ...
    Re = function (t) {
      ...
      o = this.t,
      h = o.style;
      return a.rotationX || a.rotationY || a.z || a.force3D ? (this.setRatio = Se, void Se.call(this, t))  : void (a.rotation || a.skewX ? (e = a.rotation * M, i = e - a.skewX * M, s = 100000, r = a.scaleX * s, n = a.scaleY * s, h[ye] = 'matrix(' + (0 | Math.cos(e) * r) / s + ',' + (0 | Math.sin(e) * r) / s + ',' + (0 | Math.sin(i) * - n) / s + ',' + (0 | Math.cos(i) * n) / s + ',' + a.x + ',' + a.y + ')')  : h[ye] = 'matrix(' + a.scaleX + ',0,0,' + a.scaleY + ',' + a.x + ',' + a.y + ')')
    };
    de('transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D', {
      parser: function (t, e, i, s, n, a, o) {
        ...
        d.cssText = _;
          ...
          }, f = y.directionalRotation, null != f) if ('object' == typeof f) for (_ in f) y[_] = f[_];
           else y.rotation = f;
          ...
          xe && (h.rotationX = re('rotationX' in y ? y.rotationX : 'shortRotationX' in y ? y.shortRotationX + '_short' : m.rotationX || 0, m.rotationX, 'rotationX', T), h.rotationY = re('rotationY' in y ? y.rotationY : 'shortRotationY' in y ? y.shortRotationY + '_short' : m.rotationY || 0, m.rotationY, 'rotationY', T)),
        ...
        for (xe && null != y.force3D && (m.force3D = y.force3D, c = !0), p = m.force3D || m.z || m.rotationX || m.rotationY || h.z || h.rotationX || h.rotationY || h.perspective, p || null == y.scale || (h.scaleZ = 1); --v > - 1; ) i = ve[v],
        u = h[i] - m[i],
        (u > g || - g > u || null != I[i]) && (c = !0, n = new pe(m, i, m[i], u, n), i in T && (n.e = T[i]), n.xs0 = 0, n.plugin = a, s._overwriteProps.push(n.n));
        return u = y.transformOrigin,
        (u || xe && p && m.zOrigin) && (ye ? (c = !0, i = we, u = (u || Z(t, i, r, !1, '50% 50%')) + '', n = new pe(d, i, 0, 0, n, - 1, 'transformOrigin'), n.b = d[i], n.plugin = a, xe ? (_ = m.zOrigin, u = u.split(' '), m.zOrigin = (u.length > 2 && (0 === _ || '0px' !== u[2]) ? parseFloat(u[2])  : _) || 0, n.xs0 = n.e = d[i] = u[0] + ' ' + (u[1] || '50%') + ' 0px', n = new pe(m, 'zOrigin', 0, 0, n, - 1, n.n), n.b = _, n.xs0 = n.e = m.zOrigin)  : n.xs0 = n.e = d[i] = u)  : ee(u + '', m)),
    ...
    de('borderRadius', {
      ...
      parser: function (t, e, i, n, a) {
        ...
        P = t.style;
        for (m = parseFloat(t.offsetWidth), d = parseFloat(t.offsetHeight), o = e.split(' '), h = 0; b.length > h; h++) this.p.indexOf('border') && (b[h] = q(b[h])),
        u = _ = Z(t, b[h], r, !1, '0px'),
    ...
    de('clip', {
      ...
      parser: function (t, e, i, s, n, a) {
        ...
        h,
        l;
        return 9 > f ? (h = t.currentStyle, l = 8 > f ? ' ' : ',', o = 'rect(' + h.clipTop + l + h.clipRight + l + h.clipBottom + l + h.clipLeft + ')', e = this.format(e).split(',').join(l))  : (o = this.format(Z(t, this.p, r, !1, this.dflt)), e = this.format(e)),
    ...
    var ke = function (t) {
      ...
      r = 0 | this.s + this.c * t;
      100 === r && ( - 1 === s.indexOf('atrix(') && - 1 === s.indexOf('radient(') && - 1 === s.indexOf('oader(') ? (i.removeAttribute('filter'), e = !Z(this.data, 'filter'))  : (i.filter = s.replace(x, ''), e = !0)),
    ...
    de('opacity,alpha,autoAlpha', {
      ...
      parser: function (t, e, i, s, n, a) {
        ...
        l && 1 === o && 'hidden' === Z(t, 'visibility', r) && 0 !== e && (o = 0),
        Y ? n = new pe(h, 'opacity', o, e - o, n)  : (n = new pe(h, 'opacity', 100 * o, 100 * (e - o), n), n.xn1 = l ? 1 : 0, h.zoom = 1, n.type = 2, n.b = 'alpha(opacity=' + n.s + ')', n.e = 'alpha(opacity=' + (n.s + n.c) + ')', n.data = t, n.plugin = a, n.setRatio = ke),
    ...
    h.parse = function (t, e, i, n) {
      ...
      for (a in e) c = e[a],
      h = o[a],
      h ? i = h.parse(t, c, a, this, i, n, e)  : (p = Z(t, a, r) + '', d = 'string' == typeof c, 'color' === a || 'fill' === a || 'stroke' === a || - 1 !== a.indexOf('Color') || d && b.test(c) ? (d || (c = oe(c), c = (c.length > 3 ? 'rgba(' : 'rgb(') + c.join(',') + ')'), i = ce(v, a, p, c, !0, 'transparent', i, 0, n))  : !d || - 1 === c.indexOf(' ') && - 1 === c.indexOf(',') ? (_ = parseFloat(p), f = _ || 0 === _ ? p.substr((_ + '').length)  : '', ('' === p || 'auto' === p) && ('width' === a || 'height' === a ? (_ = te(t, a, r), f = 'px')  : 'left' === a || 'top' === a ? (_ = G(t, a, r), f = 'px')  : (_ = 'opacity' !== a ? 0 : 1, f = '')), g = d && '=' === c.charAt(1), g ? (u = parseInt(c.charAt(0) + '1', 10), c = c.substr(2), u *= parseFloat(c), m = c.replace(y, ''))  : (u = parseFloat(c), m = d ? c.substr((u + '').length) || '' : ''), '' === m && (m = a in s ? s[a] : f), c = u || 0 === u ? (g ? u + _ : u) + m : e[a], f !== m && '' !== m && (u || 0 === u) && (_ || 0 === _) && (_ = $(t, a, _, f), '%' === m ? (_ /= $(t, a, 100, '%') / 100, e.strictUnits !== !0 && (p = _ + '%'))  : 'em' === m ? _ /= $(t, a, 1, 'em')  : (u = $(t, a, u, m), m = 'px'), g && (u || 0 === u) && (c = u + _ + m)), g && (u += _), !_ && 0 !== _ || !u && 0 !== u ? void 0 !== v[a] && (c || 'NaN' != c + '' && null != c) ? (i = new pe(v, a, u || _ || 0, 0, i, - 1, a, !1, 0, p, c), i.xs0 = 'none' !== c || 'display' !== a && - 1 === a.indexOf('Style') ? c : p)  : j('invalid ' + a + ' tween value: ' + e[a])  : (i = new pe(v, a, _, u - _, i, 0, a, l !== !1 && ('px' === m || 'zIndex' === a), 0, p, c), i.xs0 = m))  : i = ce(v, a, p, c, !0, null, i, 0, n)),
  ...
  window._gsDefine.plugin({
    ...
    set: function (t) {
      ...
      for (var e, i = this._overwriteProps, s = i.length; --s > - 1; ) e = i[s],
  ...
  window._gsDefine('easing.Back', [
    ...
    i = h('easing.RoughEase', function (e) {
      ...
      ], _ = 0, u = 0 | (e.points || 20), c = u, f = e.randomize !== !1, m = e.clamp === !0, d = e.template instanceof t ? e.template : null, g = 'number' == typeof e.strength ? 0.4 * e.strength : 0.4; --c > - 1; ) i = f ? Math.random()  : 1 / u * c,
      s = d ? d.getRatio(i)  : i,
  ...
  if (!e.TweenLite) {
    ...
    f = function (i, s, r, n) {
      ...
      this.check = function (h) {
        ...
        if (0 === d && r) for (_ = ('com.greensock.' + i).split('.'), u = _.pop(), p = o(_.join('.')) [u] = this.gsClass = r.apply(r, a), n && (e[u] = p, 'function' == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + '/' : '') + i.split('.').join('/'), [
        ], function () {
          return p
    ...
    w = y.register = function (t, e, i, s) {
      for (var r, n, a, o, l = e.split(','), _ = l.length, u = (i || 'easeIn,easeOut,easeInOut').split(','); --_ > - 1; ) for (n = l[_], r = s ? d('easing.' + n, null, !0)  : h.easing[n] || {
    ...
    d('Ticker', function (t, e) {
      ...
      c = function (t) {
        ...
        var e,
        n = l.time - h;
        (!i || n > 0 || t === !0) && (l.frame++, h += n + (n >= o ? 0.004 : o - n), e = !0),
        t !== !0 && (r = s(c)),
    ...
    var O = d('TweenLite', function (e, i, s) {
      ...
      n ? 'string' != typeof n ? n.length && n !== t && n[0] && (n[0] === t || n[0].nodeType && n[0].style && !n.nodeType) ? (a.splice(r--, 1), this._targets = a = a.concat(_.call(n, 0)))  : (this._siblings[r] = U(n, this, !1), 1 === h && this._siblings[r].length > 1 && j(n, this, null, 1, this._siblings[r]))  : (n = a[r--] = O.selector(n), 'string' == typeof n && a.splice(r + 1, 1))  : a.splice(r--, 1);
    ...
    r._init = function () {
      ...
      h = r.ease;
      if (r.startAt) {
        if (this._startAt && this._startAt.render( - 1, !0), r.startAt.overwrite = 0, r.startAt.immediateRender = !0, this._startAt = O.to(this.target, 0, r.startAt), o) if (this._time > 0) this._startAt = null;
         else if (0 !== a) return
      ...
      if (e && O._onPluginEvent('_onInitAllProps', this), n && (this._firstPT || 'function' != typeof this.target && this._enabled(!1, !1)), r.runBackwards) for (i = this._firstPT; i; ) i.s += i.c,
      i.c = - i.c,
      i = i._next;
    ...
    O.getTweensOf = function (t, e) {
      ...
      if ((p(t) || D(t)) && 'number' != typeof t[0]) {
        for (i = t.length, s = [
        ]; --i > - 1; ) s = s.concat(O.getTweensOf(t[i], e));
        for (i = s.length; --i > - 1; ) for (n = s[i], r = i; --r > - 1; ) n === s[r] && s.splice(i, 1)
      } else for (s = U(t).concat(), i = s.length; --i > - 1; ) (s[i]._gc || e && !s[i].isActive()) && s.splice(i, 1);
      return s
    },
